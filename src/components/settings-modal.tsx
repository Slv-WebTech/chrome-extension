    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="fixed top-4 right-4 text-white/70 hover:text-white hover:bg-white/20 p-1 rounded-full z-50"
        >
      ...
      <DialogContent className={`max-w-md w-full mx-4 ${isDarkMode
        ...
        <DialogHeader>
          <DialogTitle className={`flex items-center gap-3 text-lg ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            <svg className={`w-5 h-5 ${isDarkMode ? 'text-white' : 'text-gray-900'}`} fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" />
            </svg>
            Settings
          </DialogTitle>
        ...
        <div className="space-y-5 py-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={isDarkMode}
              onCheckedChange={(checked) => onThemeToggle(checked)}
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <svg className={isDarkMode ? 'w-5 h-5 text-white' : 'w-5 h-5 text-gray-900'} fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="space-y-2">
            <label className={`font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Search City Weather</label>
            <div className="flex gap-2">
              ...
              />
              <Button type="button" size="sm" onClick={handleCitySearch}>Search</Button>
            </div>
            <Button type="button" variant="outline" size="sm" className="w-full" onClick={onUseCurrentLocation}>
              Use Current Location Weather
            </Button>
            <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Uses free OpenWeather API. Default mode shows your current location temperature.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex rounded-lg overflow-hidden border"
              style={isDarkMode ? { borderColor: '#4b5563' } : { borderColor: '#d1d5db' }}>
              <button
                type="button"
                onClick={() => onTemperatureUnitChange('celsius')}
                className={`flex-1 py-2 text-sm font-semibold transition-colors ${temperatureUnit === 'celsius'
              ...
              <button
                ...
                className={`flex-1 py-2 text-sm font-semibold transition-colors ${temperatureUnit === 'fahrenheit'
                  ? 'bg-blue-500 text-white'
                  : isDarkMode ? 'bg-gray-800 text-gray-300 hover:bg-gray-700' : 'bg-white text-gray-600 hover:bg-gray-50'
                  }`}
              >
